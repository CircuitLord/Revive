...
// Returns a string like: L"2015-12-08_16.41.02", for use in the naming of log files.
...
//
// Example usage:
//     ForAllLogFiles(L"C:\\SomeDir", L"ServerLog_", 5, [](const char* filePath, uint64_t age)->void{ DeleteFile(filePath); });
//
