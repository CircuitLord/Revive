...
std::wstring GetLogFilenameDatestampW()
{
    char time_str[64];
    ...
    return UTF8StringToUCSString(time_str);
}

void ForAllLogFiles(const std::wstring& dirPathW, const std::wstring& fileNamePrefixW, uint64_t minAge, LogFileFunction logFileFunction)
{
